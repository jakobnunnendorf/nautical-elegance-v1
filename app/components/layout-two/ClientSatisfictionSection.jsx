...
import ClientSatisfictionCard from "./ui/ClientSatisfictionCard"

const ClientSatisfictionSection = () => {
    return (
        <div>
            <div className="flex items-center justify-center bg-navy-blue-dark flex-col gap-12 py-20 max-xl:px-5">
                <h3 className="font-lora font-medium text-white text-[55px]">What Our Clients Say</h3>
                <div className="flex gap-[50px] flex-wrap justify-center min-[1350px]:justify-normal min-[1350px]:flex-nowrap overflow-x-hidden">
                    {
                        ClientSatisfictionData.map((data, i) => (
                            <ClientSatisfictionCard key={i} {...data} />
                        ))
                    }
                </div>
            </div>
...
export default ClientSatisfictionSection
